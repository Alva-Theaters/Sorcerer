...
class SceneProperties(PropertyGroup):
    ...
    int_array_universe: IntProperty(name="Universe #", default=1, max=9999, description="Universe to start patching to on console")  
    int_array_start_address: IntProperty(name="Start Address #", default=1, max=9999, description="Address to start patching to on console") 
    int_array_channel_mode: IntProperty(name="Channel Mode", default=1, max=9999, description="How many channels each fixture needs on console") 
