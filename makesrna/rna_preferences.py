...
def register():
    ...
    Scene.is_console_saving = BoolProperty(
        default=False, name="Orb Saves Console File First", description="Safety step where Orb buttons save the console file prior to messing with stuff on the console")
